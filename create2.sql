-- Base de dados final após feedback do chatgpt
...
CREATE TABLE Conta_Cliente (
    ...
    nome TEXT ,
    contacto TEXT ,
    pontos_totais INTEGER CONSTRAINT pontosNaoNulos CHECK (pontos_totais >= 0),
...
CREATE TABLE Loja (
    ...
    telefone TEXT ,
    horario TEXT ,
    nFuncionarios INTEGER CONSTRAINT minFuncionarios CHECK (nFuncionarios >= 1),
    idLayout INTEGER,
...
CREATE TABLE Funcionario (
    ...
    salarioMensal FLOAT CONSTRAINT salarioMensalNaoNulo CHECK (salarioMensal >= 0),
    idLoja INTEGER,
...
CREATE TABLE Cargo (
    idCargo INTEGER,
    nome TEXT ,
    salarioBase FLOAT CONSTRAINT salarioBaseNaoNulo CHECK (salarioBase >= 0),
    PRIMARY KEY (idCargo)
);
...
CREATE TABLE Artigo (
    ...
    cor TEXT ,
    tamanho TEXT ,
    preco FLOAT CONSTRAINT precoNaoNulo CHECK (preco >= 0),
    idFornecedor INTEGER,
    idColecao INTEGER,
